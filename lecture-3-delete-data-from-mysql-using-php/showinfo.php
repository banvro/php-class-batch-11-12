            ...
            if ($data->num_rows > 0){
                ...
                while ($record = $data -> fetch_assoc()) {                
                    ...
                    echo "<div class='col'>
                        <div class='card'>
                        <div class='card-body'>
                            <h5 class='card-title'>{$record['full_name']} --- {$record['record_id']}</h5>
                            ...
                            <form action = 'backend.php' method = 'POST' style='    display: flex
;
    justify-content: end;
    margin-top: -6%;'>
                              <input type = 'hidden' name = 'dlt' value = 'dlt'>
                              <input type = 'hidden' name = 'card_id' value = '{$record['record_id']}'>
